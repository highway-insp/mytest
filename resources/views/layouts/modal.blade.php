<div id="registerForm" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom w3-container w3-round-large" style="max-width:600px">
		...
		<form class="w3-margin-top w3-padding-8" action="{{ route('register.store') }}" method="POST">
			...
			<input type="password" name="password_confirmation" class="w3-input" placeholder="Nhập lại Password">

			<input type="submit" value="Đăng kí" class="w3-btn-block w3-light-green w3-border w3-border-green w3-bottombar w3-round-large w3-text-white w3-large w3-margin-top w3-margin-bottom">
...
<div id="loginForm" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom w3-container w3-round-large" style="max-width:600px">
		...
		<form class="w3-margin-top w3-padding-8" action="{{route('login')}}" method="POST">>
			...
			<input type="submit" value="Đăng nhập" class="w3-btn-block w3-light-green w3-border w3-border-green w3-bottombar w3-round-large w3-text-white w3-large w3-margin-top w3-margin-bottom">
